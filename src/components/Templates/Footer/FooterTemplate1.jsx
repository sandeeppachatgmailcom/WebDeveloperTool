...
const FooterTemplate1 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://t3.ftcdn.net/jpg/05/63/83/52/360_F_563835282_EcEeNiy2UzscZrZzOHhZVWjx6E75PfHg.jpg"} alt="image" />
      <div
