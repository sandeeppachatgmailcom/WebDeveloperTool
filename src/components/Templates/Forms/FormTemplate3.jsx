...
const FormTemplate3 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://img.freepik.com/free-vector/gradient-abstract-background_23-2149131346.jpg"} alt="image" />
      <div
