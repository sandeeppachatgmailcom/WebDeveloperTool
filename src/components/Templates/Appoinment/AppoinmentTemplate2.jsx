...
const AppoinmentTemplate2 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://images6.alphacoders.com/365/365496.jpg"} alt="image" />
      <div
...
export default AppoinmentTemplate2;
