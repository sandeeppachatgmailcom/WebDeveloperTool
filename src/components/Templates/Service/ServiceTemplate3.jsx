...
const ServiceTemplate3 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://5.imimg.com/data5/SELLER/Default/2024/1/376376425/RV/WA/BV/25688617/3d-wallpaper-installation-service-500x500.jpg"} alt="image" />
      <div
