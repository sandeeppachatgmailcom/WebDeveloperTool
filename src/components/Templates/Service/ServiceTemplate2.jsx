...
const ServiceTemplate2 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://5.imimg.com/data5/SELLER/Default/2023/10/354460854/HT/PZ/LU/199676656/hd-wallpaper.jpg"} alt="image" />
      <div
