...
const ServiceTemplate1 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://e0.pxfuel.com/wallpapers/328/77/desktop-wallpaper-services-business-success.jpg"} alt="image" />
      <div
