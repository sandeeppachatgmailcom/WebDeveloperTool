...
const AboutTemplate1 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://t4.ftcdn.net/jpg/01/33/06/65/360_F_133066505_zfBuvDSTycPFkXHU7iLtAh4QpnwZ3xFs.jpg"} alt="image" />
      <div
