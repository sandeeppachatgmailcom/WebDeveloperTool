...
const SocialTemplate1 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://img.lovepik.com/photo/48008/5919.jpg_wh860.jpg"} alt="image" />
      <div
...
export default SocialTemplate1;
