...
const SocialTemplate3 = ({ textSize }) => {
  ...
  return (
    ...
    >
      <img className="w-full h-full object-cover absolute" src={"https://img.lovepik.com/photo/48008/5914.jpg_wh300.jpg"} alt="image" />
      <div
...
export default SocialTemplate3;
