...
const TitleCard = () => {
    ...
    return (
        <div className="relative w-full h-full justify-center items-center overflow-hidden flex ">
          <div className="absolute w-full h-full text-gray-800 p-10 rounded flex flex-col justify-center items-center">
            <h1 className="text-8xl">{title + title + title}</h1>
            <h1 className="text-8xl text-right">{title + title + title}</h1>
            <h1 className="text-8xl text-start">{title + title + title}</h1>
            <h1 className="text-8xl text-end">{title + title + title}</h1>
          </div>
