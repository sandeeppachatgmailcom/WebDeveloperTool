...
const Landing = () => {
    ...
    return (
        <div className="relative  w-full flex h-[100%]   " >
            <div className="  w-full overflow-hidden lg:w-3/4 h-full   justify-start bg-black items-center flex   ">
            ...
            <div className="w-full bg-black lg:w-1/4 flex flex-col relative h-[100%] ">
